    ...
    <div style="width: 88%; margin:auto;">
        <form enctype="multipart/form-data" name="myForm" id="addForm">
            ...
            <div class="flex flex-col md:w-1/2">
                ...
                <span class="ml-4 font-bold error" id="salarymsg" style="color:Red;display:none">Days must be
                    filled
                    out!</span>

                <span class="ml-4 error font-bold" id="salarymsg1" style="color:Red;display:none">Days
                    must be filled
            ...
            <div class="flex flex-col md:w-1/2">
                ...
                <input type="date" value="{{ old('leave_from') }}" name="leave_from"
                    class=" ml-2 px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                    placeholder="">
            ...
            <div class="flex flex-col md:w-1/2">
                ...
                <input type="date" value="{{ old('leave_to') }}" name="leave_to"
                    class=" ml-2 px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                    placeholder="">
